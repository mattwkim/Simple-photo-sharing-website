...
insert into Album (title, username) values ("I love sports", "sportslover");
insert into Album (title, username) values ("I love football", "sportslover");
insert into Album (title, username) values ("Around The World", "traveler");
insert into Album (title, username) values ("Cool Space Shots", "spacejunkie");
